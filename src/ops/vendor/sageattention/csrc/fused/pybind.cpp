...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("quant_per_block_int4_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, float, int, int>(&quant_per_block_int4_cuda), "quant_per_block_int4_cuda");
  m.def("quant_per_block_int4_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, int, int>(&quant_per_block_int4_cuda), "quant_per_block_int4_cuda");
  m.def("quant_per_block_int4_fuse_sub_mean_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, int, int>(&quant_per_block_int4_fuse_sub_mean_cuda), "quant_per_block_int4_fuse_sub_mean_cuda");
  m.def("quant_per_warp_int4_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, int, int, int>(&quant_per_warp_int4_cuda), "quant_per_warp_int4_cuda");
  ...
  m.def("pack_int4_cuda", py::overload_cast<torch::Tensor, torch::Tensor, int>(&pack_int4_cuda), "pack_int4_cuda");
}